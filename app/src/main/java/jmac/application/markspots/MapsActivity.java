package jmac.application.markspots;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private static final LatLng BELMONT = new LatLng ( -31.982692, 115.936779 );

    private Marker mPerth;
    private Marker mSydeney;
    private Marker mBrisbane;
    private Marker mBelmont;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mBelmont = mMap.addMarker(new MarkerOptions()
                .position(BELMONT)
                .title("Belmont")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_CYAN)));
        mBelmont.setTag(0);
        markerList.add(mBelmont);
